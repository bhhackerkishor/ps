...
while max(abs(dc)) > pwracur
    ...
    p = [ v(2)*v(1)*y(2,1)*cos(t(2,1)-d(2)+d(1)) + ...
          v(2)^2*y(2,2)*cos(t(2,2)) + ...
          v(2)*v(3)*y(2,3)*cos(t(2,3)-d(2)+d(3));
          
          v(3)*v(1)*y(3,1)*cos(t(3,1)-d(3)+d(1)) + ...
          v(3)^2*y(3,3)*cos(t(3,3)) + ...
          v(3)*v(2)*y(3,2)*cos(t(3,2)-d(3)+d(2)) ];
    
    q = -v(2)*v(1)*y(2,1)*sin(t(2,1)-d(2)+d(1)) ...
    ...
    j(1,3) = v(1)*y(2,1)*cos(t(2,1)-d(2)+d(1)) + ...
             2*v(2)*y(2,2)*cos(t(2,2)) + ...
    ...
    j(3,3) = -v(1)*y(2,1)*sin(t(2,1)-d(2)+d(1)) ...
             -2*v(2)*y(2,2)*sin(t(2,2)) ...
...
q3=-v(3)*v(1)*y(1,3)*sin(t(3,1)-d(3)+d(1))-v(3)*v(2)*y(3,2)*sin(t(3,2)-d(3)+d(2))-(v(3)^2)*y(3,3)*sin(t(3,3));
p1
q1
q3